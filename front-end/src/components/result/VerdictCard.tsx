  ...
  return (
    <div id="ringkasan" className={`rounded-xl border p-5 animate-[fadeInUp_0.4s_ease_both] ${colorClass}`}>
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        {hard_stop_triggered && (
          <span className="ml-auto flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wider text-risk-high bg-risk-high/15 px-2 py-0.5 rounded-full">
